...
@section('content')
    ...
    <div class="container ">
        @auth
        <h1>You Have {{ auth()->user()->wallet->balance }} Points</h1> @endauth
        <div class="row my-5 ">
            @foreach ($offers as $offer)
                ...
                <div class="card col-lg-4">
                    <div class="card-img-sec">
                        ...
                        <img class="card-img-top" src="{{ $offer['image'] }}" alt="Card image">
                    ...
                    <div class="card-body pt-3 pl-1">
                        ...
                        <p class="card-text pb-2">{{ $offer['description'] }} for <b>{{ $offer['point'] }}</b> points&nbsp;
                        </p>
                        ...
                        @else
                            <a href="claimOffer/{{ $offer['id'] }}">
                                <button type="button" class="btn btn-warning" id="btnClaim"><i
                                        class="fa loader-btn fa-circle-o-notch fa-spin"></i> Claim this Offer</button>
                            </a>
                        @endif @endauth
                    </div>
